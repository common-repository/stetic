	...
	class Stetic
	{
		...
		public static function stats_page()
		{
			...
			if( !empty($_POST) && isset($_POST['submit']) )
			{
				...
				$options['stetic_enable_cookies'] = isset($_POST['stetic_enable_cookies']) && $_POST['stetic_enable_cookies'] == "1" ? "1" : "0";
				...
				<div class="wrap">
					...
					<?php wp_nonce_field( '_stetic_settings__nonce' ); ?>
						<table class="form-table">
							...
							<tr>
								<td colspan="2">
									<label for="stetic_enable_cookies">Cookies:</label><br/>
									<input size="50" type="checkbox" id="stetic_enable_cookies" name="stetic_enable_cookies" value="1" <?php echo (isset($options['stetic_enable_cookies']) && $options['stetic_enable_cookies'] == "1") ? 'checked="checked"' : ""; ?>/> Enable Cookies<br/>
									<small>The Stetic tracking code does not set any cookies by default. If you like to enable cookies and more accurate tracking, check here.</small>
								</td>
							</tr>
							<tr>
								<td colspan="2">
									<label for="stetic_hide_counter">Counter:</label><br/>
...
<?php if(!isset($options['stetic_enable_cookies']) || $options['stetic_enable_cookies'] != '1') {  ?>
	_fss.v = 3;
<? } ?>
